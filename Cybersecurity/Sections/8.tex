\section{Exercise 8: Threat Modelling}
\subsection{A Simple Health App Data Flow Diagram}
The produced data flow diagram based on the description of the application can be seen below.
\begin{figure}[H]
  \vspace*{1em}
  \begin{center}
...
The updated fitness tracker app flow diagram based on the new description and information can be seen below.
\begin{figure}[H]
  \vspace*{1em}
  \begin{center}
